...
import (
	...
	versioned "git.inspur.com/szsciit/cnos/adapter/generated/cnos/clientset/versioned"
	internalinterfaces "git.inspur.com/szsciit/cnos/adapter/generated/cnos/informers/externalversions/internalinterfaces"
	v1 "git.inspur.com/szsciit/cnos/adapter/generated/cnos/listers/cnos/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CnosV1().Users().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CnosV1().Users().Watch(context.TODO(), options)
			},
		},
		&cnosv1.User{},
		resyncPeriod,
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cnosv1.User{}, f.defaultInformer)
}
