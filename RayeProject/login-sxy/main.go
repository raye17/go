...
//	cnoscontrollers "git.inspur.com/szsciit/cnos/adapter/controllers/cnos"
...
//
//		utilruntime.Must(cnosv1.AddToScheme(scheme))
...
//			LeaderElectionID:       "251bc977.inspur.com",
...
//		}
//
//		if err = (&cnoscontrollers.UserReconciler{
...
//func init() {
//	flag.StringVar(&kubeconfig, "kubeconfig", "./pkg/config/config", "Input kubernetes config file name")
//	flag.StringVar(&masterURL, "masterUrl", "https://192.168.51.90:6443", "Input kubernetes master url")
//}
